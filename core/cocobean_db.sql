...
(5, 'English Breakfast', 10.00, '2', '/cocobean.com/img/products/english-breakfast.png', 'One of the most popular tea blends in the market. Most commonly as British tea, its robust and rich black tea leaves works well with milk and sugar.', NULL, 'Green, White, Black'),
(6, 'Earl Grey', 10.00, '2', '/cocobean.com/img/products/earl-grey.png', 'Black tea that is enriched with the oils from the flavours of bergamot orange rind.', NULL, 'Green, White, Black'),
(7, 'Chai Tea', 12.00, '2', '/cocobean.com/img/products/chai.png', 'Commonly known as masala chai, its black tea leaves are usually mixed with aromatic Indian spices and herbs.', NULL, 'Green, White, Black'),
...
(9, 'Darjeeling', 14.00, '2', '/cocobean.com/img/products/darjeeling.png', 'Darjeeling tea usually resides in the northern region of India. Famously known as \"The Champagne Tea\", it consists of a combination of green, white and black tea leaves giving a lighter exotic taste.', NULL, 'Green, White, Black');
