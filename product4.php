...
<?php 
    ...
    // Good to show arrays during development
    ...
    // unset($_SESSION['productTree']); can remove once you return to debugger console
    // read only once
?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <main>
        ...
        <div class="product-container">
            <p>Price: $12</p>
            <p class="product-description">Traditional Chinese tea that is oxidised from sun heat. It consists both of green and black tea leaves giving life-long health benefits.</p>
            <p><strong>Caffeine Level:</strong> Low</p>
            <div class="caffeine-bar">
                <div class="filled-caffeine-low">
                </div>
            </div>
            <p><strong>Caffeine:</strong> 37mg/per 236ml</p>
            <input type="hidden" name="pid" value="p4">
            <h2>Leaves Type</h2>
            <?php
                foreach ($_SESSION['productTree'][PID] as $oid => $details) {
                    ...
                    <div class='quantity-box'>
                        ...
                        <input type='text' name='qty' field='qty' id='pid' class='product-amount' pattern='[1-9][0-9]*' title='Positive integers only' required value=1 oninput='updateSubtotal2()'>
